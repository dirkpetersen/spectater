...
- **3.3.2 Certificate Holder Address:**
  ...
  - Accept format variations like:
    ...
    - Any combination of address variations for these three addresses
  - REJECT any address that is NOT one of these three specific addresses
  - Do NOT accept "any address in Bend" or "any address in Corvallis" - ONLY these three
